      ...
      <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10 text-center">
            <p className="text-slate-700 font-medium mb-2">Invalid or expired reset link</p>
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="bg-white py-8 px-10 shadow rounded-lg text-center">
          <p className="text-slate-800 font-semibold mb-2">Password updated!</p>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
          <h2 className="mb-6 text-xl font-semibold text-slate-800">Set a new password</h2>
